      ...
      <div className="navbar fixed h-20 bg-base-100 flex justify-center z-10">
        <div className="max-w-6xl w-full">
          ...
          <div className="navbar-end flex grow-0 justify-end w-1/3">
            <div className="flex justify-end w-2/5 hidden lg:flex">
              ...
              <div className="flex justify-end items-center w-full">
                {authenticated ? (
                  <div className="w-full flex justify-end items-center">
                    <Link to="#">
                      <BsPerson size={25} strokeWidth={0} className="mr-5" />
                    </Link>
                    <div className="btn btn-sm bg-red-500 hover:bg-red-600 border-none">
                      <Link
                        to="/"
                        onClick={() => {
